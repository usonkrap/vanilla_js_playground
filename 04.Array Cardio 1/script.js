// Get your shorts on - this is an array workout!
    ...
    const sortedAlpha = people.sort((lastOne, nextOne) => {
      const [lastNameA, firstNameA] = lastOne.split(', ');
      const [lastNameB, firstNameB] = nextOne.split(', ');
    ...
    const transfortation = data.reduce(function(obj, item) {
      if(!obj[item]) obj[item] = 0;
      obj[item]++;
      return obj;
    },{});
    console.log(transfortation);